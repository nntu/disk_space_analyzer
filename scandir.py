...
for (dirpath, dirnames, filenames) in walk(my_path):
    ...
    conn.execute('''INSERT INTO Windows10 (Filename,Path,Parent,fileExt,isFolder) VALUES (?, ?, ?, ?, ?)''', params)
    conn.commit()
    ...
    for i in filenames:
        ...
        conn.execute('''INSERT INTO Windows10 (Filename,Path,Parent,fileExt,isFolder,size,hashfile)  VALUES (?, ?, ?, ?, ?,?,?)''', params)
        conn.commit()
